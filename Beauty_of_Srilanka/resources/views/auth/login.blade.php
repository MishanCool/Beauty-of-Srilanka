...
<html lang="en">
  <head>
    <title>Beauty Of Sri Lanka sign in</title>
    <meta charset="utf-8">
...
{{-- @section('content') --}}
<section class="ftco-section ftco-no-pt ftc-no-pb mt-5 mb-5">
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">{{ __('Login Only For Admin') }}</div>
